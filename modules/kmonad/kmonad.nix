## This file gets KMONAD as a nix package.
#! Only change this file if https://github.com/kmonad/kmonad/blob/master/doc/installation.md#nixos says so. 
let 
    
    _ = builtins.trace "  fetching: kmonad from nixpkgs..." {}; 
