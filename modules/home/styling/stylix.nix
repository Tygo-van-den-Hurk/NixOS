  ...
  config.${category} = mkIf config.${namespace}.${type}.${category}.enable {
    ...
    image = pkgs.stdenv.mkDerivation rec {
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-3147.3225303193467 -2992.9837954790196 11119.632365326193 5985.967590958039"
          ...
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="linear-gradient-44584babfef90c4cb32c8ee42b1193ba" x1="-319.9999999999999" x2="127.99999999999996" y1="-554.2562584220408" y2="221.70250336881628">
              <stop offset="$offset1" stop-color="$dark_base08" />
              <stop offset="$offset2" stop-color="$base08" />
              <stop offset="$offset3" stop-color="$base08" />
              <stop offset="$offset4" stop-color="$light_base08" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="linear-gradient-96af2d924a4fbf5b015c244addc578a8" x1="-319.9999999999999" x2="127.99999999999996" y1="-554.2562584220408" y2="221.70250336881628">
              <stop offset="$offset1" stop-color="$dark_base09" />
              <stop offset="$offset2" stop-color="$base09" />
              <stop offset="$offset3" stop-color="$base09" />
              <stop offset="$offset4" stop-color="$light_base09" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="linear-gradient-33ff75d118a188d564af252422e7cc92" x1="-319.9999999999999" x2="127.99999999999996" y1="-554.2562584220408" y2="221.70250336881628">
              <stop offset="$offset1" stop-color="$dark_base0A" />
              <stop offset="$offset2" stop-color="$base0A" />
              <stop offset="$offset3" stop-color="$base0A" />
              <stop offset="$offset4" stop-color="$light_base0A" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="linear-gradient-2a0b6b52f041088f95dc76196e6b4d88" x1="-319.9999999999999" x2="127.99999999999996" y1="-554.2562584220408" y2="221.70250336881628">
              <stop offset="$offset1" stop-color="$dark_base0B" />
              <stop offset="$offset2" stop-color="$base0B" />
              <stop offset="$offset3" stop-color="$base0B" />
              <stop offset="$offset4" stop-color="$light_base0B" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="linear-gradient-c6751d2115edfa2506ed6789e247b928" x1="-319.9999999999999" x2="127.99999999999996" y1="-554.2562584220408" y2="221.70250336881628">
              <stop offset="$offset1" stop-color="$dark_base0D" />
              <stop offset="$offset2" stop-color="$base0D" />
              <stop offset="$offset3" stop-color="$base0D" />
              <stop offset="$offset4" stop-color="$light_base0D" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="linear-gradient-6b2d1737e4a2ebfe17f3769056568c22" x1="-319.9999999999999" x2="127.99999999999996" y1="-554.2562584220408" y2="221.70250336881628">
              <stop offset="$offset1" stop-color="$dark_base0E" />
              <stop offset="$offset2" stop-color="$base0E" />
              <stop offset="$offset3" stop-color="$base0E" />
              <stop offset="$offset4" stop-color="$light_base0E" />
            </linearGradient>
          </defs>
      ...
      patchPhase = /* Shell */ ''
        ...
        sed -i "$name.svg" \
          -e "s/\\\$offset1/$offset1/g" \
          -e "s/\\\$offset2/$offset2/g" \
          -e "s/\\\$offset3/$offset3/g" \
          -e "s/\\\$offset4/$offset4/g"
        runHook postPatch
      '';
      ...
      buildPhase = /* Shell */ ''
        ...
        python3 -m cairosvg "$name.svg" --output "$name" \
