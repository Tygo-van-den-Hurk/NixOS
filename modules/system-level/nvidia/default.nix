...
if module-settings.enable then
  builtins.trace "(System) Loading: ${toString ./.}... " {
    hardware.nvidia.prime = {
      ...
      offload =
        if module-settings.prime.offload then
          {
            enable = true;
    ...
    hardware.nvidia = {
      ...
      package =
        ...
        (
          if (module-settings.hardwarePackage == "stable") then
            stable
          else if (module-settings.hardwarePackage == "beta") then
            beta
          else if (module-settings.hardwarePackage == "production") then
            production
          else if (module-settings.hardwarePackage == "vulkan_beta") then
            vulkan_beta
          else if (module-settings.hardwarePackage == "legacy_470") then
            legacy_470
          else if (module-settings.hardwarePackage == "legacy_390") then
            legacy_390
          else if (module-settings.hardwarePackage == "legacy_340") then
            legacy_340
          else
